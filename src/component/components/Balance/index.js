...
function Balance(props) {
    ...
    const getMyWalletAddress = () => {
        return userInfo.base58;
    }

    const getAffiliateWalletAddress = () => {
        return affiliate.base58;
    }
                    ...
                    <Col span={10} offset={1}>
                        <YellowButton onClick={async () => {
                            ...
                            if (tokenAction == 0 && selToken == 0) {
                                ...
                                if (affiliate?.wallet && Number(props.balance) <= 0) {
                                    ...
                                    if (compareWallet == 0) {
                                        openNotification(4.5, "Invalid wallet address", `Switch your Tronlink account, your wallet address is ${userInfo.base58}`, false, null);
                                        return;
                                    }
